<main class="container mx-auto px-4 py-10 max-w-4xl">
    <article class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
      <header class="mb-8">
        ...
        <h1 class="text-4xl font-extrabold text-gray-900 mb-4 leading-tight">Mastering Tailwind CSS in 2026</h1>
        <div class="flex items-center gap-4 text-gray-500 text-sm">
          <span class="font-medium text-gray-700">By John Doe</span> • <span>Published Jan 07, 2026</span> • <button class="text-[#197fe6] hover:underline font-bold">Add to Favorites ❤️</button>
        </div>
      </header>

      <div class="prose max-w-none text-lg text-gray-700 leading-relaxed mb-8">
        <p class="mb-6 text-xl text-gray-500 italic font-light">"The future of web development is utility-first."</p>
        <p>Article content goes here. The user can view embedded images and videos seamlessly.</p>
        
        <div class="my-8 aspect-video bg-gray-100 flex flex-col items-center justify-center border-2 border-dashed border-[#197fe6] rounded-xl group hover:bg-blue-50 transition">
          <span class="text-[#197fe6] text-4xl mb-2">▶</span>
          <p class="text-[#197fe6] font-semibold text-sm">Media Placeholder (Image/Video)</p>
        </div>
      </div>
