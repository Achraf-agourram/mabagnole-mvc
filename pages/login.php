            ...
            <div class="w-full max-w-[440px] flex flex-col gap-8">
                ...
                <div class="w-full">
                    <div class="flex border-b border-slate-200 dark:border-slate-700">
                        <a href="login.php" class="flex flex-1 flex-col items-center justify-center border-b-[3px] border-primary pb-3 pt-2">
                            <span class="text-primary text-sm font-bold leading-normal tracking-[0.015em]">Log In</span>
                        </a>
                        <a href="register.php" class="flex flex-1 flex-col items-center justify-center border-b-[3px] border-transparent pb-3 pt-2 hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
                            <span
                                class="text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 text-sm font-bold leading-normal tracking-[0.015em]">Sign
                                Up</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-4 flex items-center justify-center gap-2">
                    <span class="text-slate-500 dark:text-slate-400 text-sm">Don't have an account?</span>
                    <a class="text-primary text-sm font-bold hover:underline" href="register.php">Sign up now</a>
                </div>
                <!-- Trust Badge -->
